...
/* 12/08/14 : on rajoute cette partie */
...
run ;
 ...
 /* 12/08/14 : on rajoute dispo eq 1 mais en fait ce sera 0 */
...
if _n_ eq &i and dispo eq 1 then call symput("var&&pays&l.._&i",trim(left(nomvar))) ;
%end ;
run ;
