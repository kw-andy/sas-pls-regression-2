...
if _n_ eq &i and dispo eq 0 then call symput("zvar&&pays&l.._&i",trim(left(nomvar))) ; /*3) on a rajoute */
else call symput("uvar&&pays&l.._&i",trim(left(nomvar))) ; 
/* 1) modif avec le else au lieu du else if = ko*/ 
/*2) modif avec le else au lieu du else if = ok*/
...
format zerovarnum_&i_&j 10.3 unvarnum_&i_&j 10.3; 
unvarnum_&i._&j=&&&&uvar&&pays&l.._&i._t&j; 
...
/*proc sql;
update <nom_table> set <nom_colonne>=varnum_&i._&j, <dispo>="oui/non" 
quit;*/
