...
/*13) on fait un tri de a*/
    ...
    if _n_ eq &i and dispo eq 0 then call symput("var&&pays&l.._&i",trim(left(nomvar))) ; /*3) on a rajoute */
    %end ;
    run ;
    ...
    varnum_&i._&j=&&&&var&&pays&l.._&i._t&j;  /*unvarnum_&i._&j=&&&&uvar&&pays&l.._&i._t&j; -> ca coince ici*/
    %end ; %end; 
