...
if var1="ei_cphi_m.tsv" then do; periode="m"; date_publi1="http://bit.ly/1pL3Czw";end;
...
if var1="ei_lmjv_q_r2.tsv" then do; periode="q"; date_publi1="N/A enco";end;
...
if var1="prc_hicp_cann.tsv" then do; periode="m"; date_publi1="http://bit.ly/1pL3Czw";end;
if var1="prc_hicp_midx96.tsv" then do; periode="m"; date_publi1="http://bit.ly/1pL3Czw";end;
if var1="prc_hpi_q.tsv" then do; periode="q"; ajoutdate=126;end;
if var1="prc_ipc_g20.tsv" then do; periode="q"; date_publi1="http://bit.ly/WQNWEt";end;
