...
/* penser à enlever MT, HR et CY si pas encore de choix*/
/* et penser à changer   %do l=1 %to 28 ; par le nombre adequat*/
...
/* on supprime la dernière ligne , avec la date maximum*/
